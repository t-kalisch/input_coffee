...
if st.session_state.logged_in == True:
    ...
    if break_length.total_seconds() < 20:
        ...
        if st.session_state.admin == True:
            ...
            submit_button = col2.button("Add coffee to coffee break", help = "A break is under way. Join it by adding a coffee here.", on_click=submit_coffee, args=(name, "add"))
        else:
        ...
        if st.session_state.admin == True:
            name = col2.text_input("Drinker", placeholder = "Username")
            submit_button = col2.button("Start a coffee break", help = "Start a break and add a coffee to your name here.", on_click=submit_coffee, args=(name, "new"))
        else:
